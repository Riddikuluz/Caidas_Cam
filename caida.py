            ...
            if confidence > confidence_threshold:
                ...
                if class_id == person_class_id:
                    ...
                    if box_width > box_height * 1.5:
                        ...
                        cv2.putText(img, text, (startX, startY - 30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 255), 2)
                        cv2.rectangle(img, (startX, startY), (endX, endY), (0, 0, 255), 2)
                    else:
                        cv2.rectangle(img, (startX, startY), (endX, endY), (0, 255, 0), 2)

                    person_text = f"Person: {confidence:.2f}"
                    cv2.putText(img, person_text, (startX, startY - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
